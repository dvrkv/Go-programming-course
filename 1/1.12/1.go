...
var workArray [10]uint8 //массив
var a, b uint8          //индексы элементов массива

for i := range workArray { //***1 этап - ввод массива*** Создаем бесконечный цикл, закончится, когда будет достаточно значений
	fmt.Scan(&workArray[i])
}
for i := 0; i < 3; i++ { //***2 этап - ввод индексов элементов массива***
	fmt.Scan(&a, &b)
