...
func main() {
	...
	conv, _ := time.Parse(time.RFC3339, input) //конвертируем строку в RFC3339

	fmt.Println(conv.Format(time.UnixDate)) //конвертируем RFC3339 в строку в представлении формата UnixDate
}
